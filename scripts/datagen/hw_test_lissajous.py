...
def simple_replan(selected_waypoints, duration, order, p, vf, rho, idx):
    ...
    nn_coeffs = load_object(
        r"/home/anusha/Research/ws_kr/src/layered_ref_control/src/layered_ref_control/data/nn_coeffs.pkl")
    # import ipdb;
    # ipdb.set_trace()
    start = rospy.Time.now()
...
def main():
    ...
    # vf.network = trained_model_state
    ...
    save_object(times_nn,
                '/home/anusha/Research/ws_kr/src/layered_ref_control/src/layered_ref_control/data/times_nn.pkl')
